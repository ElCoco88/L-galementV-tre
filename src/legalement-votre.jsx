...
<body>
  ...
  <pre>${safeContent}</pre>
  <div class="disc">⚠ Document informatif uniquement. Consultez un avocat pour toute procédure.</div>
...
const RIGHTS_THEMES = [
  ...
  { id:"prudhommes", icon:"⚖", color:"#6366f1", title:"Prud'hommes & Recours", topics:[
    ...
    { q:"Faut-il un avocat aux Prud'hommes ?", simple:"Non, pas obligatoire (sauf appel). Vous pouvez vous faire représenter par un délégué syndical ou un défenseur syndical (gratuit via syndicats)." },
...
---
⚖ Généré par LégalementVôtre — À titre informatif uniquement. Consultez un avocat pour votre situation spécifique.`;
}
...
const AIDE_JURIDICTIONNELLE = [
  { nom: "Aide juridictionnelle (gratuite)", desc: "Si vos revenus sont inférieurs à ~1 100 €/mois, vous avez droit à un avocat entièrement gratuit.", url: "https://www.service-public.fr/particuliers/vosdroits/F18074", icon: "⚖" },
  { nom: "Maisons de Justice et du Droit", desc: "Consultations juridiques gratuites avec des avocats bénévoles, sans conditions de ressources.", url: "https://www.justice.fr/structure/maison-justice-droit", icon: "🏛" },
  ...
  { nom: "Conseil de Prud'hommes", desc: "Saisine possible sans avocat. Formulaire en ligne ou au greffe du CPH le plus proche.", url: "https://www.service-public.fr/particuliers/vosdroits/F2360", icon: "🏢" },
];
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto" }}>
      ...
      <div style={{ textAlign: "center", padding: "48px 16px 36px" }}>
        ...
        <h1 style={{ fontSize: "clamp(30px,5vw,52px)", fontWeight: 900, color: "#0f172a", lineHeight: 1.1, marginBottom: 16, letterSpacing: -1 }}>
          Votre avocat du travail<br/><span style={{ background:"linear-gradient(135deg,#2563eb,#7c3aed)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>virtuel & gratuit</span>
        </h1>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          <Btn onClick={() => setPage("chat")} style={{ fontSize: 15, padding: "13px 28px", borderRadius: 99 }}>💬 Chat IA Avocat</Btn>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: 12, marginBottom: 28 }}>
        {[
          ...
          { icon:"💬", title:"Chat IA avocat", desc:"Questions illimitées 24h/24", page:"chat", color:"#7c3aed", bg:"#f5f3ff" },
          ...
          <Card key={f.title} onClick={() => setPage(f.page)} className="feature-card"
            ...
            <div style={{ fontWeight: 700, color: "#0f172a", fontSize: 14, marginBottom: 3 }}>{f.title}</div>
      ...
      <div style={{ background:"#fefce8", border:"1px solid #fde68a", borderRadius:16, padding:"13px 18px" }}>
        <div style={{ fontSize: 12, color: "#92400e", lineHeight: 1.6 }}>
          <strong>⚠ Avertissement :</strong> LégalementVôtre fournit des informations à titre indicatif. Consultez un avocat pour votre situation spécifique.
        </div>
      </div>
    </div>
  );
...
function ChatPage() {
  ...
  async function sendMessage(text) {
    ...
    try {
      const systemPrompt = `Tu es un avocat spécialisé en droit du travail français pour l'application LégalementVôtre. 
Règles strictes :
...
5. Rappelle de consulter un avocat pour les cas complexes
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", display: "flex", flexDirection: "column", height: "calc(100vh - 140px)" }}>
      <div style={{ padding: "16px 0 12px", borderBottom: "1px solid rgba(99,130,191,0.15)" }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 22, color: "#0f172a", margin: 0 }}>💬 Chat IA Avocat</h2>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "16px 0", display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        {loading && (
          <div style={{ display: "flex" }}>
            <div style={{ background: "#ffffff", border: "1px solid rgba(99,130,191,0.2)", borderRadius: "16px 16px 16px 4px", padding: "12px 16px" }}>
      ...
      <div style={{ padding: "12px 0", borderTop: "1px solid rgba(99,130,191,0.15)", display: "flex", gap: 10 }}>
        <input
          ...
          style={{ flex: 1, background: "#f8fafc", border: "1px solid rgba(99,130,191,0.25)", borderRadius: 12, padding: "12px 16px", color: "#1e293b", fontSize: 14, outline: "none" }}
        />
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto" }}>
      <div style={{ marginBottom: 20 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>📄 Générateur de Lettres</h2>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 16, flexWrap: "wrap" }}>
        <input value={search} onChange={e => setSearch(e.target.value)} placeholder="🔍 Rechercher une lettre..."
          style={{ flex: 1, minWidth: 200, background: "#f8fafc", border: "1px solid rgba(99,130,191,0.25)", borderRadius: 10, padding: "9px 14px", color: "#1e293b", fontSize: 14, outline: "none" }} />
        {cats.map(c => (
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(260px,1fr))", gap: 12 }}>
        {filtered.map(l => (
          <Card key={l.id} onClick={() => setSelected(l)} style={{ cursor: "pointer", transition: "all 0.2s" }}>
            ...
            <div style={{ fontWeight: 700, color: "#1e293b", fontSize: 14, marginBottom: 4 }}>{l.title}</div>
...
function SimulatorsPage() {
  ...
  return (
    <div style={{ maxWidth: 820, margin: "0 auto" }}>
      <div style={{ marginBottom: 20 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>🔢 Simulateurs Juridiques</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
          ...
          {result && (
            <Card style={{ background: "#f0fdf4", borderColor: "#86efac" }}>
              ...
              <pre style={{ fontSize: 14, color: "#334155", lineHeight: 1.9, whiteSpace: "pre-wrap", fontFamily: "inherit" }}
...
function GlossaryPage() {
  ...
  return (
    <div style={{ maxWidth: 820, margin: "0 auto" }}>
      <div style={{ marginBottom: 20 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>📚 Glossaire Juridique</h2>
      ...
      <input value={search} onChange={e => setSearch(e.target.value)} placeholder="🔍 Rechercher un terme..."
        style={{ width: "100%", background: "#f8fafc", border: "1px solid rgba(99,130,191,0.25)", borderRadius: 12, padding: "12px 16px", color: "#1e293b", fontSize: 15, outline: "none", marginBottom: 20, boxSizing: "border-box" }} />
        ...
        {filtered.map(g => (
          <Card key={g.term} style={{ cursor: "pointer" }} onClick={() => { setExpanded(expanded === g.term ? null : g.term); if (expanded !== g.term) getAiExplanation(g.term); }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <span style={{ fontWeight: 700, color: "#1e293b", fontSize: 15 }}>{g.term}</span>
            ...
            {expanded === g.term && (
              <div style={{ marginTop: 12, borderTop: "1px solid rgba(99,130,191,0.15)", paddingTop: 12 }}>
                ...
                {loading === g.term ? (
                  ...
                  <div style={{ background: "#eff6ff", borderRadius: 10, padding: "10px 14px", fontSize: 13, color: "#334155", lineHeight: 1.7, borderLeft: "3px solid #4f83ff" }}>
...
function ContractPage({ setPage }) {
  ...
  const SYSTEM_PROMPT = `Tu es un avocat expert en droit du travail français pour LégalementVôtre.
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto" }}>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>🔍 Analyse de Contrat IA</h2>
      ...
      {!analysis && (
        <div
          ...
          {file ? (
            ...
            <>
              <div style={{ color: "#1e293b", fontWeight: 700, fontSize: 16, marginBottom: 6 }}>Glissez votre contrat ici</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "auto 1fr", gap: 20, alignItems: "center" }}>
            ...
            <Card>
              ...
              <p style={{ color: "#334155", fontSize: 14, lineHeight: 1.7, margin: 0 }}>{analysis.resume}</p>
            </Card>
          </div>
          ...
          <Card style={{ background: "#eff6ff", borderColor: "#bfdbfe" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {(analysis.actions_recommandees || []).map((a, i) => (
                <div key={i} style={{ fontSize: 13, color: "#334155", lineHeight: 1.5, display: "flex", gap: 10 }}>
          ...
          <Card style={{ background: "#fef2f2", borderColor: "rgba(239,68,68,0.15)", padding: "12px 16px" }}>
            <p style={{ color: "#64748b", fontSize: 12, margin: 0, lineHeight: 1.6 }}>
              <strong style={{ color: "#f87171" }}>⚠ Avertissement :</strong> Cette analyse est fournie à titre informatif uniquement. Elle ne constitue pas un avis juridique. Pour contester une clause ou engager une procédure, consultez un avocat spécialisé en droit du travail.
            </p>
          </Card>
        </div>
      )}
...
function NewsPage() {
  return (
    <div style={{ maxWidth: 820, margin: "0 auto" }}>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>📰 Veille Juridique 2026</h2>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        {NEWS_2026.map((n, i) => (
          <Card key={i}>
            ...
            <h3 style={{ color: "#0f172a", fontSize: 17, fontWeight: 800, marginBottom: 8, fontFamily: "'Plus Jakarta Sans',sans-serif" }}>{n.title}</h3>
...
function QuizPage() {
  ...
  if (done) return (
    <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
      <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 28, color: "#0f172a", marginBottom: 24 }}>⚡ Résultat du Diagnostic</h2>
      ...
      <div style={{ textAlign: "left", marginBottom: 20 }}>
        {answers.map((a, i) => (
          <div key={i} style={{ display: "flex", gap: 10, alignItems: "flex-start", marginBottom: 10 }}>
            ...
            <div>
              <div style={{ color: "#334155", fontSize: 13 }}>{QUIZ_QUESTIONS[i].q}</div>
  ...
  return (
    <div style={{ maxWidth: 600, margin: "0 auto" }}>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>⚡ Quiz Diagnostic Employeur</h2>
      ...
      <Card style={{ marginBottom: 20 }}>
        ...
        <h3 style={{ color: "#0f172a", fontSize: 18, lineHeight: 1.5, fontFamily: "'Plus Jakarta Sans',sans-serif", marginBottom: 24 }}>{q.q}</h3>
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
...
function DeadlinesPage() {
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto" }}>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>🆘 Urgences & Délais Légaux</h2>
        ...
        <Card style={{ marginBottom: 20, background: "#fef2f2", borderColor: "#fecaca" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {alerts.map(a => {
              ...
              return (
                <div key={a.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: "#f1f5f9", borderRadius: 8, padding: "8px 12px" }}>
                  <div>
                    <span style={{ color: "#1e293b", fontSize: 13, fontWeight: 600 }}>{a.label}</span>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, maxHeight: 340, overflowY: "auto" }}>
            {DEADLINES.map(d => (
              <button key={d.id} onClick={() => { setSelected(d.id); setResult(null); }} style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span style={{ color: "#1e293b", fontSize: 13, fontWeight: 600 }}>{d.label}</span>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {result && (
            <Card style={{ background: result.expired ? "rgba(239,68,68,0.08)" : result.daysLeft < 30 ? "rgba(245,158,11,0.08)" : "rgba(16,185,129,0.08)", borderColor: result.expired ? "rgba(239,68,68,0.3)" : result.daysLeft < 30 ? "rgba(245,158,11,0.3)" : "rgba(16,185,129,0.3)" }}>
              ...
              <div style={{ color: "#64748b", fontSize: 13, marginTop: 6 }}>Date limite : <strong style={{ color: "#1e293b" }}>{result.limitDate}</strong></div>
              ...
              {result.expired && (
                <div style={{ marginTop: 12, padding: "10px 14px", background: "rgba(239,68,68,0.12)", borderRadius: 8, fontSize: 12, color: "#fca5a5" }}>
                  Même expiré, consultez un avocat — certains délais peuvent être suspendus ou prorogés dans des cas particuliers.
                </div>
              )}
            </Card>
          )}
...
function DashboardPage({ setPage }) {
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto" }}>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>📊 Mon Tableau de Bord</h2>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
        <h3 style={{ color: "#1e293b", fontSize: 16, fontWeight: 700 }}>📁 Mes Dossiers</h3>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div>
                  <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 4 }}>
                    <span style={{ color: "#1e293b", fontWeight: 700, fontSize: 15 }}>{d.titre}</span>
...
function ProofsPage() {
  ...
  function exportPDF() {
    ...
    const full = `JOURNAL DE BORD — LégalementVôtre\nExporté le ${new Date().toLocaleDateString("fr-FR")}\n${"═".repeat(60)}\n\n${txt}\n\n⚖ Ce journal peut être présenté à un avocat ou au Conseil de Prud'hommes.`;
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto" }}>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>🗂 Journal de Preuves</h2>
      ...
      <Card style={{ background: "#f0fdf4", borderColor: "#bbf7d0", marginBottom: 20, padding: "12px 18px" }}>
        <div style={{ fontSize: 13, color: "#6ee7b7" }}>🔒 <strong>Stockage local uniquement.</strong> Vos notes ne quittent jamais votre appareil. En cas de procédure, exportez le PDF et remettez-le à votre avocat.</div>
      </Card>

      <div style={{ display: "flex", gap: 10, marginBottom: 20 }}>
        <input value={search} onChange={e => setSearch(e.target.value)} placeholder="🔍 Rechercher dans vos notes..." style={{ flex: 1, background: "#f8fafc", border: "1px solid rgba(99,130,191,0.25)", borderRadius: 10, padding: "9px 14px", color: "#1e293b", fontSize: 14, outline: "none" }} />
            ...
            <Card key={e.id}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ color: "#334155", fontSize: 14, lineHeight: 1.6, margin: "6px 0" }}>{e.description}</p>
...
function SupportPage() {
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto" }}>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>🤝 Aide & Soutien Gratuit</h2>
      ...
      {tab === "syndicats" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <Card style={{ background: "#eff6ff", borderColor: "#bfdbfe", padding: "12px 18px" }}>
            <p style={{ color: "#64748b", fontSize: 13, margin: 0 }}>💡 <strong style={{ color: "#1e293b" }}>Le saviez-vous ?</strong> Vous pouvez contacter un syndicat <strong style={{ color: "#2563eb" }}>sans être adhérent</strong>. La plupart offrent une première consultation gratuite.</p>
          </Card>
          {SYNDICATS.map(s => (
            <Card key={s.nom}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
      ...
      {tab === "aide" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <Card style={{ background: "#f0fdf4", borderColor: "#bbf7d0", padding: "12px 18px" }}>
            <p style={{ color: "#6ee7b7", fontSize: 13, margin: 0 }}>✅ <strong>Ces ressources sont 100% gratuites.</strong> L'aide juridictionnelle vous donne droit à un avocat sans frais si vos revenus sont modestes.</p>
          </Card>
            ...
            <Card key={a.nom}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div>
                  ...
                  <div style={{ fontWeight: 700, color: "#1e293b", fontSize: 15, marginBottom: 6 }}>{a.nom}</div>
        ...
        <div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 16 }}>
            {[
              ...
              <div key={l} style={{ background: "#f1f5f9", borderRadius: 10, padding: "12px 14px" }}>
          ...
          <div style={{ background: "#eff6ff", borderRadius: 10, padding: "12px 14px", fontSize: 12, color: "#64748b", lineHeight: 1.6, marginBottom: 12 }}>
            📊 SJR calculé : <strong style={{ color: "#1e293b" }}>{result.sjr} €/j</strong> · Premier versement : <strong style={{ color: "#1e293b" }}>{result.dateDebut}</strong>
          </div>
...
function MultilingualPage() {
  ...
  return (
    <div style={{ maxWidth: 820, margin: "0 auto" }}>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>🌍 Support Multilingue</h2>
      ...
      {answer && (
        <Card>
          ...
          <p style={{ color: "#334155", fontSize: 14, lineHeight: 1.8, margin: 0, direction: lang === "ar" ? "rtl" : "ltr", textAlign: lang === "ar" ? "right" : "left" }}>{answer}</p>
        </Card>
      )}
    </div>
  );
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto" }}>
      <div style={{ marginBottom: 24 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 24, color: "#0f172a", marginBottom: 8 }}>📖 Mes Droits au Quotidien</h2>
      ...
      {!theme ? (
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(240px,1fr))", gap: 14 }}>
          {RIGHTS_THEMES.map(r => (
            <Card key={r.id} onClick={() => setTheme(r.id)} style={{ cursor: "pointer", borderLeft: `3px solid ${r.color}` }}>
              ...
              <div style={{ fontWeight: 700, color: "#0f172a", fontSize: 16, marginBottom: 4 }}>{r.title}</div>
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
            ...
            <h3 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 20, color: "#0f172a", margin: 0 }}>{t.icon} {t.title}</h3>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {t.topics.map((topic, i) => (
              <Card key={i} style={{ cursor: "pointer" }} onClick={() => { const k = topic.q; setExpanded(expanded === k ? null : k); if (expanded !== k) getDetail(topic); }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                  <div style={{ flex: 1 }}>
                    <div style={{ fontWeight: 700, color: "#1e293b", fontSize: 15 }}>{topic.q}</div>
                    {expanded !== topic.q && (
                ...
                {expanded === topic.q && (
                  <div style={{ marginTop: 14, borderTop: "1px solid rgba(99,130,191,0.15)", paddingTop: 14 }}>
                    <div style={{ background: "#eff6ff", borderRadius: 10, padding: "12px 14px", marginBottom: 12, borderLeft: `3px solid ${t.color}` }}>
                      <p style={{ color: "#334155", fontSize: 14, lineHeight: 1.7, margin: 0 }}>{topic.simple}</p>
                    </div>
                    {aiLoading === topic.q ? (
...
');
  ...
  function exportSynthesePDF() {
    ...
    lines.push('', '⚠ Ce rapport est une analyse indicative. Consultez un avocat ou un syndicat');
  ...
  async function generateLetter(item, type) {
    ...
    const LETTRE_PROMPT = 'Tu es avocat specialise droit du travail. Redige une lettre de mise en demeure professionnelle, ferme mais courtoise.\n'
...
function TotalDuCalculator({ monthlyTotal, anomalies, indemnites, parseEur, setPage, moisAnalyse, ancienneteMois, dateEntree }) {
  ...
  function exportDette() {
    const lines = [
      ...
      "", "⚠ Estimation indicative. Consultez un avocat ou un syndicat.",
  ...
  return (
    <div style={{ marginTop:16 }}>
      <Card style={{ background:'linear-gradient(135deg,rgba(220,38,38,0.08),rgba(239,68,68,0.05))', borderColor:'rgba(220,38,38,0.3)' }}>
        ...
        <p style={{ fontSize:10, color:'var(--text-muted)', marginTop:8, marginBottom:0, textAlign:'center' }}>Prescription 3 ans (art. L3245-1) · Estimation indicative, consultez un avocat</p>
      </Card>
    </div>
  );
}
...
function SituationReellePage({ setPage }) {
  ...
  async function getAdvice() {
    ...
    try {
      ...
      const d = await r.json();
      const raw = (d.content?.map(b=>b.text||'').join('')||'').replace(/```json|```/g,'').trim();
      try { setAdvice(JSON.parse(raw)); } catch(_e) { setAdvice({resume:'Conseil chargé.', priorites:['Consultez un avocat spécialisé'], droits:[], recours:'syndicat', urgence:'moyenne'}); }
  ...
  return (
    <div className={`theme-${theme}`} style={{ minHeight:'100vh', background:'var(--bg)', color:'var(--text-primary)', fontFamily:"'Plus Jakarta Sans',system-ui,sans-serif", maxWidth:480, margin:'0 auto', position:'relative' }}>
      ...
      <div style={{ position:'fixed', bottom:0, left:'50%', transform:'translateX(-50%)', width:'100%', maxWidth:480, background:'var(--card-bg)', borderTop:'1px solid var(--border)', display:'flex', zIndex:200 }}>
        ...
        <button onClick={()=>setDrawerOpen(!drawerOpen)} style={{ flex:1, padding:'10px 4px 8px', background:'none', border:'none', display:'flex', flexDirection:'column', alignItems:'center', gap:3, cursor:'pointer', opacity:drawerOpen?1:0.5 }}>
      ...
      {/* More drawer */}
      {drawerOpen && (
        <div style={{ position:'fixed', bottom:56, left:'50%', transform:'translateX(-50%)', width:'100%', maxWidth:480, background:'var(--card-bg)', borderTop:'1px solid var(--border)', padding:'16px', zIndex:150, borderRadius:'16px 16px 0 0', boxShadow:'0 -8px 32px rgba(0,0,0,0.3)' }}>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:8 }}>
            {morePages.map(item=>(
              <button key={item.id} onClick={()=>{setPage(item.id);setDrawerOpen(false);}} style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:4, padding:'10px 6px', background:'var(--input-bg)', borderRadius:10, border:'none', cursor:'pointer' }}>
                <span style={{ fontSize:20 }}>{item.icon}</span>
                <span style={{ fontSize:9, fontWeight:700, color:'var(--text-muted)', textAlign:'center', lineHeight:1.2 }}>{item.label}</span>
              </button>
            ))}
          </div>
        </div>
