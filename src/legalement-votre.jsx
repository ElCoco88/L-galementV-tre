...
// Le créateur du site ne reçoit aucune clé, aucun argent.
// ============================================================
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: 14, padding: '16px', marginBottom: 16 }}>
        ...
        <div style={{ background: 'rgba(22,163,74,0.08)', border: '1px solid rgba(22,163,74,0.25)', borderRadius: 10, padding: '12px', marginBottom: 10 }}>
          <p style={{ color: '#16a34a', fontSize: 13, fontWeight: 700, margin: 0 }}>
            ✅ Le créateur de ce site ne reçoit aucun argent.
          </p>
          <p style={{ color: 'var(--text-secondary)', fontSize: 12, margin: '4px 0 0', lineHeight: 1.5 }}>
            Votre paiement va directement à Anthropic si vous dépassez leurs crédits gratuits. Ce site est un outil militant, pas un business.
          </p>
        </div>
    ...
    <div style={{ background: 'rgba(37,99,235,0.07)', border: '1px solid rgba(37,99,235,0.2)', borderRadius: 12, padding: '10px 14px', marginBottom: 16, fontSize: 13 }}>
      ...
      {open && (
        <div style={{ marginTop: 10, color: 'var(--text-secondary)', lineHeight: 1.6, fontSize: 12 }}>
          <p style={{ marginBottom: 8 }}>Toutes les fonctionnalités de base — lettres, simulateurs, glossaire, délais, journal des preuves, analyse automatique des fiches — fonctionnent <strong>sans aucun appel à une IA</strong>. Elles sont donc entièrement gratuites.</p>
          <p style={{ marginBottom: 8 }}>Certaines fonctions avancées (analyse IA approfondie, chat juridique, génération de lettres sur mesure) utilisent l'API Claude d'Anthropic. Chaque appel nous coûte quelques centimes. C'est pourquoi ces fonctions peuvent nécessiter un petit paiement à l'avenir.</p>
          <p style={{ color: '#2563eb', fontWeight: 600 }}>Notre engagement : la majorité des outils resteront toujours gratuits.</p>
        </div>
      )}
    </div>
  );
