  ...
  useEffect(() => {
    ...
    if (theme === 'dark') {
      ...
      styleTag.textContent = `
        ...
        .theme-dark [style*="color: \"#0f172a\""], .theme-dark [style*="color:\"#0f172a\""],
        .theme-dark [style*="color: \"#1e293b\""], .theme-dark [style*="color:\"#1e293b\""] {
        ...
        .theme-dark [style*="background: \"#f8fafc\""], .theme-dark [style*="background:\"#f8fafc\""],
        .theme-dark [style*="background: \"#f1f5f9\""], .theme-dark [style*="background:\"#f1f5f9\""] {
          background: #1e293b !important;
          border-color: #334155 !important;
        }
        .theme-dark [style*="background: \"#f0fdf4\""] { background: rgba(22,163,74,0.1) !important; }
        .theme-dark [style*="background: \"#fef2f2\""] { background: rgba(239,68,68,0.1) !important; }
        .theme-dark [style*="background: \"#fefce8\""], .theme-dark [style*="background:\"#fefce8\""] { background: rgba(234,179,8,0.1) !important; }
        .theme-dark [style*="background: \"#fff7f7\""] { background: rgba(239,68,68,0.08) !important; }
        .theme-dark [style*="background: \"#f5f3ff\""] { background: rgba(139,92,246,0.15) !important; }
        ...
        .theme-dark [style*="color: \"#1e293b\""], .theme-dark [style*="color:\"#1e293b\""],
        .theme-dark [style*="color: \"#0f172a\""] { color: #e2e8f0 !important; }
      `;
    } else {
