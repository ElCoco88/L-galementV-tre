  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", display: "flex", flexDirection: "column", height: "calc(100vh - 140px)" }}>
      <div style={{ padding: "16px 0 12px", borderBottom: "1px solid rgba(99,130,191,0.15)" }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 22, color: "#0f172a", margin: 0 }}>💬 Chat IA Juridique</h2>
...
${c.text.slice(0,3000)}`).join('\n\n');
  ...
  async function generateLetter(item, type) {
    ...
    const LETTRE_PROMPT = 'Tu es un outil d'information sur le droit du travail. Redige une lettre de mise en demeure professionnelle, ferme mais courtoise.\n'
